...
La locomoción de las especies y el comportamiento de las mismas están fuertemente relacionados. Su evolución y desarrollo están guiados por su necesidad de adaptación al entorno. La adaptaci\'on es guiada principalmente por prueba-y-error a todo momento. La naturaleza del entorno por su complejidad hace que un individuo no tenga pleno conocimiento de su entorno y ante ello sus comportamientos deben ser robustos ante eventos imprevistos del entorno y su propio cuerpo.
...
% Falta un parrafo de conclusión que se acople con el titulo de la sección

\section{Hacia la cognici\'on y los reflejos encarnados}
\label{sec:hacia}
En el diseño de humanoides actual, la motricidad gruesa requiere de un gran esfuerzo en la programación de sus comportamientos. Sin embargo se cree que al dotar al humanoide en su morfología con características bio-inspiradas procedentes del sistema NMS, es posible solucionar varios problemas presentes en la locomoción humanoide y proponer nuevas estructuras de control jerárquicas que reutilicen lo aprendido.

%Éstas características como el ZMP, que duró años la ingeniería en proponer para lograr una locomoción sub-óptima, es un claro ejemplo de una característica diseñada manualmente que vigila el balance de la caminata y con base a su valor tomar una decisión de control.
La morfología del NMS, sobre el cual sobre su composición neuronal, se puede construir un controlador jerárquico con cualidades cognitivas, que permita extraer características de forma automática. Éstas características como el ZMP, que duró años la ingeniería en proponer para lograr una locomoción sub-óptima, es un claro ejemplo de una característica diseñada manualmente que vigila el balance de la caminata y con base en su valor tomar una decisión de control. Problemas abiertos como la búsqueda de restricciones virtuales de forma \emph{on-line} en HZD o caracterizar mejor la fase de doble soporte~\cite{Grizzle2014} son problemas abordables al analizar las señales del NMS como lazo sensoriomotor.
